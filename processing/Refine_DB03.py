...
INPUT_PATH = Path("Json_Files/DB03_expc_parsed_ALL.json")
OUTPUT_PATH = Path("Json_Files/DB03_expc_refined.json")
TIMEOUT = 10
...
def build_json_url(detail_link: str) -> str:
    """법령해석례상세링크의 type=HTML을 type=JSON으로 바꿔 완전한 URL 생성"""
...
def main():
    ...
    if isinstance(data, dict):
        for key in ("law", "items", "data", "expc"):
